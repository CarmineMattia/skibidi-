  ...
  return (
    ...
    >
      ...
      <View className="flex-row justify-between items-start mb-4">
        ...
        <Pressable
          onPress={onRemove}
          className="bg-destructive/10 p-3 rounded-full active:bg-destructive/30 active:opacity-70"
          hitSlop={12}
        >
      ...
      <View className="flex-row justify-between items-center">
        {/* Quantity Controls - Larger buttons for boomer accessibility */}
        <View className="flex-row items-center bg-secondary/50 rounded-xl p-1.5 border border-border/50">
          <Pressable
            onPress={() => onUpdateQuantity(quantity - 1)}
            className="w-12 h-12 items-center justify-center bg-card rounded-lg shadow-sm active:bg-card/70 active:opacity-70"
          >
          ...
          <Pressable
            onPress={() => onUpdateQuantity(quantity + 1)}
            className="w-12 h-12 items-center justify-center bg-primary rounded-lg shadow-sm active:bg-primary/70 active:opacity-70"
          >
