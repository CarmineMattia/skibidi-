  ...
  return (
    ...
    >
      ...
      <View className="flex-row justify-between items-center">
        {/* Quantity Controls */}
        <View className="flex-row items-center bg-secondary/50 rounded-xl p-2 border border-border/50">
          <Pressable
            onPress={() => onUpdateQuantity(quantity - 1)}
            className="w-14 h-14 items-center justify-center bg-card rounded-lg shadow-sm active:scale-95"
          >
            <Text className="text-foreground font-bold text-2xl leading-none pb-1">−</Text>
          </Pressable>

          <View className="w-16 items-center px-2">
          ...
          <Pressable
            onPress={() => onUpdateQuantity(quantity + 1)}
            className="w-14 h-14 items-center justify-center bg-primary rounded-lg shadow-sm active:scale-95"
          >
