  ...
  return (
    ...
    >
      ...
      <View className="flex-row justify-between items-center">
        {/* Quantity Controls - Larger buttons for accessibility */}
        <View className="flex-row items-center bg-secondary/50 rounded-2xl p-2 border border-border/50">
          <Pressable
            onPress={() => onUpdateQuantity(quantity - 1)}
            className="w-14 h-14 items-center justify-center bg-card rounded-xl shadow-sm active:scale-95 active:bg-secondary"
            accessibilityRole="button"
          ...
          <Pressable
            onPress={() => onUpdateQuantity(quantity + 1)}
            className="w-14 h-14 items-center justify-center bg-primary rounded-xl shadow-sm active:scale-95 active:bg-primary/80"
            accessibilityRole="button"
