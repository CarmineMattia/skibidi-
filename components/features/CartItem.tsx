      ...
      <View className="flex-row justify-between items-center">
        ...
        <View className="flex-row items-center bg-secondary/50 rounded-xl p-1.5 border border-border/50">
          <Pressable
            ...
            className="w-12 h-12 items-center justify-center bg-card rounded-lg shadow-sm active:bg-primary/20"
          >
          ...
          <Pressable
            onPress={() => onUpdateQuantity(quantity + 1)}
            className="w-12 h-12 items-center justify-center bg-primary rounded-lg shadow-sm active:bg-primary/80"
          >
