      ...
      <View className="w-[400px] bg-secondary/10 p-8 justify-between">
        ...
        <View>
          ...
          <View className="flex-row gap-3">
            ...
            />
            <Pressable
              className="bg-primary flex-[2] h-14 rounded-xl items-center justify-center border-2 border-primary"
            ...
            >
              {isProcessing ? (
                <View className="flex-row items-center gap-2">
                  ...
                  <Text className="text-primary-foreground font-extrabold text-lg">Elaborazione...</Text>
                </View>
              ) : (
